...
document.body.addEventListener("click", function (event) {
  var activeAccordion = document.querySelector(".collapse.show");
  var clickedElement = event.target;

  // Check if the clicked element is not inside the active accordion
  if (!activeAccordion.contains(clickedElement)) {
